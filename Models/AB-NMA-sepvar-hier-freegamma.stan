...
data {
  ...
  real<lower = 0> scale_gamma;  // scale for gamma parameters
...
transformed parameters {
  ...
  vector[nstudy] beta;
  vector[n_gamma] gamma; // scaled gammas
  ...
  gamma = scale_gamma * z_gamma; // scaled gammas
  Gamma = make_Gamma(gamma, ntrt); // Gamma matrix from gamma elements
